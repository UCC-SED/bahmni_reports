...
public class ReportHeader {
    ...
    public JasperReportBuilder add(JasperReportBuilder jasperReportBuilder, String reportName, String startDate, String endDate) {
       ...
       // addTitle(reportName, headerList);
        ...
        addCustomTitle( reportName,   startDate,  endDate,  headerList);
    ...
    private void addCustomTitle(String reportName,  String startDate, String endDate, HorizontalListBuilder headerList) {
        headerList.add(Templates.createTitleComponentForTZMinistry( reportName, reportName, "From " + startDate + " to " + endDate))
                .newRow()
                .add(cmp.verticalGap(5));
    }
