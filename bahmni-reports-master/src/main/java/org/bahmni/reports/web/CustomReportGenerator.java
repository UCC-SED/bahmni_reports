...
public class CustomReportGenerator {
    private static final Logger logger = Logger.getLogger(CustomReportGenerator.class);
    private CustomReportParams reportParams;
    ...
    public CustomReportGenerator(CustomReportParams reportParams, OutputStream outputStream, AllDatasources allDatasources, BahmniReportsProperties bahmniReportsProperties, HttpClient httpClient, JasperResponseConverter converter) {
    ...
    public void invoke() throws Exception {
        ...
        try {
            ...
            logger.info("reportParams.getResponseType() " +  reportParams.getResponseType());
            converter.customConvertToResponseType(reportParams, bahmniReportsProperties.getMacroTemplatesTempDirectory(), outputStream, concatenatedReportBuilder);
