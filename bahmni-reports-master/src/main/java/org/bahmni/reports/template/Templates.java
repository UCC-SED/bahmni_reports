...
import org.bahmni.reports.util.Constant;
...
public class Templates {
    ...
    public static final StyleBuilder bold9CenteredStyle;
    ...
    static {
        ...
        boldCenteredStyle = stl.style(boldStyle)
            ...
            bold9CenteredStyle= stl.style(boldCenteredStyle)
                .setFontSize(9);
                 bold11CenteredStyle = stl.style(boldCenteredStyle)
                .setFontSize(11);
    ...
    public static ComponentBuilder<?, ?> createTitleComponent(String label) {
        ...
        public static   ComponentBuilder<?, ?> createTitleComponentForTZMinistry(String programTitle, String reportTitle, String dateRange) {
           
               ComponentBuilder<?, ?> dynamicReportsComponent0
                = cmp.horizontalList(
                        cmp.image(Templates.class.getResource("/images/img.png")).setFixedDimension(60, 60),
                        cmp.verticalList(
                                cmp.text(Constant.COUNTRY_TITLE)
                                        .setStyle(bold9CenteredStyle)
                                        .setHorizontalAlignment(HorizontalAlignment.CENTER),
                                cmp.text(Constant.MINISTRY_TITLE)
                                        .setStyle(bold9CenteredStyle)
                                        .setHorizontalAlignment(HorizontalAlignment.CENTER),
                                cmp.text(programTitle)
                                        .setStyle(bold9CenteredStyle)
                                        .setHorizontalAlignment(HorizontalAlignment.CENTER),
                                  cmp.text(reportTitle)
                                        .setStyle(bold9CenteredStyle)
                                        .setHorizontalAlignment(HorizontalAlignment.CENTER),
                                cmp.text(dateRange)
                                        .setStyle(bold9CenteredStyle)
