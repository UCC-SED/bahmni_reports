...
public class CohortReportTemplate extends BaseReportTemplate<AggregationReportConfig> {

    private BahmniReportsProperties bahmniReportsProperties;
    private static final Logger logger = Logger.getLogger(CohortReportTemplate.class);
    SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");

    public CohortReportTemplate(BahmniReportsProperties bahmniReportsProperties) {
    ...
    public BahmniReportBuilder build(Connection connection, JasperReportBuilder jasperReport,
        ...
        try {
            ...
            JasperReportBuilder jasperReportBuilder = report()
                    ...
                    .addParameter("start_date", sdf.parse("2018-05-11"))
                    .setParameter("end_date", new Date())
                    .setParameter("follow_up_period", 6)
                    .setParameter("CTCID", "123REF12")
                    .setParameter("HFRID", "321323")
                    .setParameter("TypeOfService", "CTC")
                    .setParameter("reportingPeriod", sdf.format(new Date()))
                    .setParameter("dateCompletion", sdf.format(new Date()))
                    ...
                    .setParameter("designation", "Data Manager")
